...
ages by integrating advanced static analysis with rich GitHub metadata—including reporting of issues, role
of maintainers and the community. The framework emphasizes the identification of security risks, dependency-
related issues, and severity patterns, providing actionable insights to help developers prioritize and resolve critical
problems in large-scale JavaScript ecosystems.


## Detection of Cipher Types Using ML (BTech Project at IIEST-Shibpur: 2022-23)
**Description:** Developed a sequence-to-sequence model using CNNs and Transformers to identify cryptosystems from cipher-
texts, achieving 96.72% accuracy on a dataset of 130K samples.
